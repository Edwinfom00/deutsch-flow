...
import { ImportedGrammarPage } from "@/modules/import/components/ImportedGrammarPage";
import { getImportedExercisesByType } from "@/modules/import/server/imported-content.actions";

async function Content() {
  const data = await getImportedExercisesByType("grammar");
  return <ImportedGrammarPage data={data} />;
}

export default function ImportGrammarRoute() {
  return (
